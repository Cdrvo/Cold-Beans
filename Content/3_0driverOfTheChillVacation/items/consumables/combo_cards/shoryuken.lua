SMODS.Consumable {
    ...
    calculate = function(self, card, context)
        if context.repetition and context.cardarea == G.play and context.other_card == context.scoring_hand[1] and card.ability.immutable.sequence > 0 then
            return {
