SMODS.PokerHand({
	...
	visible = function (self)
        local jokers = ColdBeans.joker_cache.house_rules and (ColdBeans.joker_cache.sticker_collection or ColdBeans.joker_cache.stickerbomb)
        local clicked
	...
	evaluate = function(parts, hand)
		if ColdBeans.joker_cache.house_rules and (ColdBeans.joker_cache.sticker_collection or ColdBeans.joker_cache.stickerbomb) then -- if we have the house rules
...
SMODS.PokerHand({
	...
	evaluate = function(parts, hand)
		if ColdBeans.joker_cache.house_rules and (ColdBeans.joker_cache.sticker_collection or ColdBeans.joker_cache.stickerbomb) and next(parts.cbean_nteam_collection_part) and next(parts._3) then -- if we have the house rules
