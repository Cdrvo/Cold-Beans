...
SMODS.Atlas{
    key = "sdown_vouchers",
    path = "2_SeriousDownloading/vouchers.png",
    px = 71,
    py = 95,
}

SMODS.Atlas({
    key = "blessingpack_atlas",
    path = "2_SeriousDownloading/BlessingsPacks.png",
    px = 71,
    py = 95,
})
...
SMODS.Atlas({
    key = "sdown_joker_atlas",
    path = "2_SeriousDownloading/Jokers.png",
    px = 71,
    py = 95,
})
