...
--Yeah! Mostly artist: (RattlingSnow353) I commented out two zoiac packs to have collection appear nicer.
--I also adjusted the weights to be more in line with base games and fixed a posioning issue with the mega blessing pack.
