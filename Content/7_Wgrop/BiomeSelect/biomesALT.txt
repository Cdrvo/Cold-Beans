-- this is an alternate version of biomes.lua where the pools are different for certain jokers.
...
CBWG.ColdBeans_Biome {
    ...
    cards = {["j_rough_gem"] = true, ["j_golden"] = true, ["j_arrowhead"] = true, ["j_onyx_agate"] = true, ["j_madness"] = true, ["j_bloodstone"] = true, ["j_lusty"] = true, ["j_half"] = true, ["j_chaos"] = true, ["j_abstract"] = true, ["j_stone"] = true, ["j_glass"] = true, ["j_burnt"] = true, ["j_cbean_pboys_molotov"] = true, ["j_cbean_yma_charred_fool"] = true, ["j_mad"] = true, ["j_clever"] = true, ["j_even_steven"] = true, ["j_steel_joker"] = true},
    calculate = function(self, context)
    end,
    enter = function(self, calc)
