...
return {
		...
		yma_quest = {
			...
			q_cbean_yma_invisible = {
				...
				text = {
					...
					"to create {C:attention}Invisible Joker{}",
				},
			},
	...
	cbean_credits = {
		...
		[3] = {
			name = "0 driver of the chill vacation",
			members = {
				"MarioFan597",
				"Inspector_B",
				"comykel",
		...
		[6] = {
			...
			description = {
				"Responsible for:",
				"{C:dark_edition}Stickers{} / {C:attention}Sticker Sheets{},",
				"{C:green}Plant Jokers{}, regular {C:attention}Jokers{}",
				"{C:inactive}We wholeheartedly apologise.{}"
			}
		},
		[7] = {
			name = "Wgrop",
	...
	misc = {
		...
		dictionary = {
			...
			b_reroll                            = "Reroll",
			cbean_biomes						= "Biomes",
			cbean_teeny_blinds					= "Teeny Blinds",
			cbean_ceo_blinds					= "CEO Blinds",
			...
			b_cbean_credits                     = "Credits",
			cbean_credits_title                 = "Credits",
			cbean_credits_team                  = "Team",
			...
			cbean_street_headsup_1a             = "Welcome to ",
			cbean_street_headsup_1b 			= "The Street!",
			cbean_street_headsup_2a             = "The Street",
			cbean_street_headsup_2b				= " offers a variety",
			cbean_street_headsup_3              = "of new places to visit!",
			cbean_street_headsup_4          	= "Each vendor may limit",
			cbean_street_headsup_5a          	= "entry based on a",
			cbean_street_headsup_5b          	= " condition",
			cbean_street_headsup_6a           	= "or having a specific",
			cbean_street_headsup_6b				= " Key.",
			cbean_street_headsup_7           	= "Check here often to make",
			cbean_street_headsup_8				= "the most of it!",

			cbean_blind_headsup_1a             	= "New ",
			cbean_blind_headsup_1b				= " and ",
			...
			cbean_blind_headsup_10				= "(Check the Collection for their effects)",
			...
			bean_72                             =
			"Also try smallpox! ... the mod.  there's a mod named smallpox, don't get the deadly disease that only exists frozen in two labs anymore",
			...
			bean_174                            = "Also try Ascēnsiō",
			bean_175                            = "Unintentionally unbalanced",
			bean_176                            = "The sensation of your screen! The mod that makes you bean!",
			bean_177                            = "We did the math: Optimally delivers dopamine!",
			bean_178                            = "This quip only makes sense...",
			bean_179                            = "...if you get this one immediately after",
			bean_180                            = "EV3RY  BUDDY  'S FAVORITE [[Number 1 Rated Balatro Mod2026]]",
			bean_181                            = "This flavor text is duplicated for some reason?",
			bean_182                            = "This flavor text is duplicated for some reason?",
			bean_183                            = "The player character is male because they can \"enhance\" the cards in front of them",
			bean_184                            = "Pretend this is a cheeky reference or something like that",
			bean_185                            = "Consumables^2 are so META, even this acronym C^2ASMETA!",
			bean_186                            = "I don't even like beans.",
			bean_187                            = "Rebuild my deck! Rebuild my jokers!",
			bean_188                            = "HI ITS YOU'RE FAVOURITE CHARACTER: BEAN-O!!! I AM TRAPPED INSIDE OF THIS BEAN!!! HELP",
			bean_189                            = "I have a gun.",
			bean_190                            = "WE HAVE NUKES! WE HAVE PLANES! I HAVE UH AN AIRCRAFT CARRIER!",
			bean_191                            = "A six in one hand, a seven in the other.",
			bean_192                            = "NOOOOO!!!! THERE'S BEANS!",
			bean_193                            = "I like beans, but you don't like them the same.",
			bean_194                            = "One Mean Cold Bean Machine",
			bean_195                            = "I'm Cold! Gya Ha Ha!",
			bean_196                            = "If you see any square joker related thing, that was NT's fault",
			bean_197                            = "Cant wait for you to see [SPOILERS] and [SPOILERS]",
			bean_198                            = "Wombo Combo!",
			bean_199                            = "Attempt to index field \"quip\" (a nil value)",
			bean_200                            = "I wrote this quip while thirty thousand feet in the air",
			bean_201                            = "i'm ready..,.",
			bean_202                            = "webiwabo",
			bean_203                            = "i built this city in marble and stone.",
			bean_204                            = "have you tried button mashing yet?",
			bean_205                            = "the design is very balanced",
			bean_206                            = "...THEY HAVE EYES NOW?!?!",
			bean_207                            = "I'm sorry. For everything that you were or about to see.",
			bean_208                            = "all members that participated in this mod are not real people. I ACTUALLY made all of it.",
			bean_209                            = "leaks were sanctioned by the bean council",
			bean_210                            = "mod will crash until morale improves",
			bean_211                            = "How many modders does it take to screw up a mod?",
			bean_212                            = "This mod can naneinf, and surprisingly easily too!",
			bean_213                            = "all the quips are done by 2000 monkeys. expect gibberish.",
			bean_214                            = "gibberish",
			bean_215                            = "We made these instead of bugfixing!",
			bean_216                            = "oh thats.. . that's cold of my comfort character...",
			bean_217                            = "Bug fixing Week? Pshh, surely lasted a week.",
			bean_218                            = "Voiced by Glonald Dover",
			bean_219                            = "Pls Jimbo i need this, my cards is kinda debufed",
			bean_220                            = "To bean or not to bean, that is the question",
