...
if __name__ == "__main__":
    ...
    output_directory = "../../2x/6_NameTeam" #omg hai it's me GhostSalt! thanks pissboys <3 i know you got this from another team but like. y'know. piss. if you catch my drift
